...
@section('content')
    <script src="https://cdn.tiny.cloud/1/vwmwrc6ddj5crgy8a7up75mgshoa2j2a1guyqx0fsgu9m1mz/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <form action="{{ route('chapters.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @if($book->category =='novel')
                        <textarea name="content" placeholder="Write Content here" required style="height:70vh">
                            {{ old('content') }}
                        </textarea>
                        <script>
                            tinymce.init({
            ...
            <div class="col-md-3 mt-2">
                ...
                <div class="card card-body">
                    ...
                    <div>
                        tags : <a href="#">tag 1</a>, <a href="#">tag 4</a>, <a href="#">tag 2</a>, <a href="#">tag 5</a>
                    </div>
